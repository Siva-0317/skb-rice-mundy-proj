...
import { createPurchase, getNextPurchaseBill, getRecentPurchases } from '../firebase/purchases';
        ...
        <div className="lg:w-2/3 flex flex-col gap-6">
          <div className="bg-white rounded-2xl shadow-sm border border-border overflow-hidden">
            <div className="p-5 border-b border-border flex justify-between items-center bg-panel/30">
              <h2 className="font-display text-xl font-semibold text-brownDark">New Purchase Invoice</h2>
